...
@section('content')
    <div class="mb-4">
        ...
        <p class="mb-0 text-secondary">
            Selamat datang di IKM, {{ Auth::user()->name }}.
        </p>
    </div>
                        ...
                        <div class="d-flex gap-4">
                            ...
                            <div>
                                <h4 class="text-dark fw-semibold mb-0">
                                    {{ Auth::user()->profilIkm->outlets->count() }} Outlet
                                </h4>
                ...
                <div class="card border card-dashboard">
                    <div class="card-body p-4">
                        <div class="d-flex gap-4">
                            ...
                            <div>
                                <h4 class="text-dark fw-semibold mb-0">
                                    {{ Auth::user()->profilIkm->produk->count() }} Produk
                                </h4>
                                <p class="text-secondary mb-0">
                                    @if (Auth::user()->profilIkm->produk->count() > 0)
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex gap-4">
                            ...
                            <div>
                                ...
                                <a href="{{ route('user.profile.edit') }}"
                                    class="justify-content-start btn btn-link btn-sm text-primary ps-0 d-inline">
                                    Manage Profil <i class="ai-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
